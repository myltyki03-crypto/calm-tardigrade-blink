                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="relative">
                      <img
                        src={member.user_avatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80'}
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {isOwner && (
                          <span className="inline-flex items-center gap-0.5 text-[9px] bg-pink-950/80 text-pink-400 border border-pink-500/40 px-1.5 py-0.2 rounded-full font-bold">
