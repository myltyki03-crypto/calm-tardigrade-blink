...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-slate-950/95 backdrop-blur-lg border-t border-purple-900/40 px-6 py-2 flex items-center justify-between">
      <button
        onClick={() => navigate('/')}
