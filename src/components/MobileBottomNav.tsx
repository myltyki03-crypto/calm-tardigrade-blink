...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-3 left-6 right-6 z-50 md:hidden bg-slate-950/85 backdrop-blur-2xl border border-purple-500/30 px-6 py-2 rounded-3xl flex items-center justify-between shadow-[0_10px_35px_rgba(0,0,0,0.85)] ring-1 ring-white/10">
      {/* 1. Лента */}
      <button
        onClick={() => navigate('/')}
      ...
      >
        ...
        <span className="text-[10px] tracking-tight">Лента</span>
        {isHome && (
